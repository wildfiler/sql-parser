...
racc_goto_table = [
   ...
   238,    76,    14,   217,   218,   116,   117,    62,    65,    13,
   131,    66,     1,    97,   109,   145,    93,   182,   108,    90,
...
racc_goto_check = [
    ...
    47,    19,    23,    43,    44,    60,    60,    22,    22,    21,
    11,    23,     1,    17,    27,    28,    12,    29,    12,     8,
...
racc_goto_pointer = [
   nil,    32,    68,    62,    61,    59,    50,    41,   -16,   -48,
   nil,   -62,   -19,  -143,   nil,    -7,   -47,   -23,   -96,    -7,
  -131,    21,    14,    14,   -53,   nil,   nil,   -29,   -74,  -108,
